        ...
        <div className="max-w-5xl mx-auto flex justify-between items-center">
            ...
            <div className="hidden md:flex gap-2 ml-4">
              {user.role === Role.USER && (
                <button
                  ...
                  className="px-3 py-1.5 text-sm rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300 flex items-center gap-1"
                >
              ...
              {user.role === Role.USER && (
                <button
                  ...
                  className="relative px-3 py-1.5 text-sm rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300 flex items-center gap-1"
                >
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {user.role === Role.USER && (
              <button
                onClick={() => navigate("/chat")}
                className="relative md:hidden p-2 text-slate-500 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg"
              >
                <Headphones size={20} />
                {unreadCount > 0 && (
            ...
            {user.role === Role.USER && (
              <button
                onClick={() => navigate("/leaderboard")}
                className="md:hidden p-2 text-slate-500 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg"
              >
                <Award size={20} />
              </button>
            )}
            ...
            <div className="relative">
              ...
              >
                <Globe size={20} />
                <span className="uppercase font-medium text-xs hidden sm:inline">
                  {language}
                </span>
              </button>
